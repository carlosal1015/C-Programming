...
\usepackage[tmargin=2cm,rmargin=2cm,lmargin=2cm,bmargin=2cm]{geometry}
...
\end{center}
\vspace{0.1in}
\makebox[\textwidth]{Nombres y apellidos:\enspace\ Carlos Alonso Aznarán Laos.\hfill}
\vspace{0.2in}
...
\caption{Programa \texttt{exercise1_3a.c}.}
\label{lst:3a}
\end{listing}
...
\caption{Programa \texttt{exercise1_5.c}.}
\label{lst:5}
\end{listing}
\end{solution}
