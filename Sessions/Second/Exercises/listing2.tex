...
\begin{enumerate}[(a)]
	\item \mintinline{c}{int}, posiblemente \mintinline{c}{short} o \mintinline{c}{unsigned} o \mintinline{c}{unsigned short} pues representan un número entero.
	
	\item \mintinline{c}{float}, es poco probable que el costo sea un número entero exacto. (Podría usar el \mintinline{c}{double} pero realmente no necesita la precisión adicional).
	
	\item \mintinline{c}{char}.
	
	\item \mintinline{c}{int}, posiblemente \mintinline{c}{unsigned}.
\end{enumerate}
\end{solution}
...
\begin{enumerate}[label={Línea \arabic*:},leftmargin=1.2cm]
	...
	\item Debe ir ``los argumentos'' de la función \mintinline{c}{main}, es decir, \mintinline{c}{main()}. Use \{, no (.
...
\centering
	\begin{tabular}{|c|c|c|c|}
		...
		\multicolumn{2}{|c|}{\bfseries Constant} & \textbf{Type} & \textbf{Specifier}	\\
		\hline
		A	&	\mintinline{c}{012} 	& \mintinline{c}{unsigned int}	& \mintinline{c}{%#o}	\\
		\hline
		B 	&	\mintinline{c}{2.9e05L}& \mintinline{c}{long double}&	\mintinline{c}{%Le}\\
		\hline
		C	&	\mintinline{c}{'s'}	& \mintinline{c}{char} (realmente \mintinline{c}{int})	&	\mintinline{c}{%c}\\
		\hline
		D	&	\mintinline{c}{10000} 	& \mintinline{c}{long}	&	\mintinline{c}{%ld}\\
		\hline
		E	&	\mintinline{c}{'\n'} 	& \mintinline{c}{char} (realmente \mintinline{c}{int})	&	\mintinline{c}{%c}\\
		\hline
